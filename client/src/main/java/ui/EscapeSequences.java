...
public class EscapeSequences {
    ...
    public static final String SET_BG_COLOR_DARK_BROWN = SET_BG_COLOR + "180m";
    public static final String SET_BG_COLOR_LIGHT_BROWN = SET_BG_COLOR + "137m";
    public static final String SET_BG_COLOR_WHITE = SET_BG_COLOR + "15m";
    public static final String HIGHLIGHT_BG_OVER_DARK_BROWN = SET_BG_COLOR + "27m"; // Yellow
    public static final String HIGHLIGHT_BG_OVER_LIGHT_BROWN = SET_BG_COLOR + "87m"; // Yellow
    public static final String SET_BG_COLOR_SOFT_DARK_GREEN = SET_BG_COLOR + "65m";
    public static final String SET_BG_COLOR_SOFT_LIGHT_GREEN = SET_BG_COLOR + "108m";
